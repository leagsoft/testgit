...
nIntroduct  = Replace(Trim(Request("NewsContent")),"'","’")
...
<table width="90%" border="1" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFDFDF" bordercolorlight="#333333" bordercolordark="#FFFFFF">
  ...
  <tr>
    <td colspan="2" bgcolor="#FFDA99" valign="middle" height="30">&nbsp;<a href="index.asp">宣传园地管理</a> -> <font color=red>信息维护</font></td>
  </tr>
  <tr>
...
<table width="95%" border=0 cellpadding=1 cellspacing=0 align="center">
    <tr>
      <td width="10%" align="right"><font color="brown">分类：</td>
      <td width="90%">
...
%>
    ...
    <tr>
      <td width="10%" align="right"><font color="brown">标题：</td>
      <td width="90%"><input type="text" name="nProName" size="50" maxlength="100" value="<%=nProName%>"></td>
    </tr>
    <tr>
      <td width="10%" align="right"><font color="brown">介绍：</td>
      <!--<td width="80%"><textarea rows="10" name="nIntroduct" cols="50" ><%=nIntroduct%></textarea></td>-->
      <!--<td height="400" valign="top" bgcolor="buttonface" Id="tdNewsContent"><textarea name="NewsContent"></textarea></td>-->
      <td width="90%" height="400" valign="top" bgcolor="buttonface" Id="tdNewsContent"><textarea name="NewsContent"><%if nIntroduct<>"" then Response.Write Server.HtmlEnCode(nIntroduct) end if%></textarea></td>
    </tr>
    <tr>
      <td width="10%" align="right"><font color="brown">图片：</td>
      <td width="90%"><INPUT TYPE="Text" Name="nPic" Size="50" value="<%=nPic%>"> <A onClick="window.open('FileSystem/View.asp','ResWin','resizable,scrollbars,width=600,height=500')" style="cursor:hand" title="按此增加图片"> <font color=red><u>增加</u></font> </A></td>
    </tr>
  </table><br> 
  <br>
    </td>
