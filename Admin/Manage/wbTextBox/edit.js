...
{
	var arr = showModalDialog("wbTextBox/swf.htm", "", "dialogWidth:18em; dialogHeight:13em; status:0; help:0");
...
{
	var arr = showModalDialog("wbTextBox/wmv.htm", "", "dialogWidth:18em; dialogHeight:14em; status:0; help:0");
...
function WBTB_forrm()
{
	var arr = showModalDialog("wbTextBox/rm.htm", "", "dialogWidth:18em; dialogHeight:14em; status:0; help:0");
...
function WBTB_forimg()
{
	...
	var arr=showModalDialog("wbTextBox/img.htm",window, "dialogWidth:26em; dialogHeight:20.5em; status:0; help:0");
	WBTB_Composition.focus();
	if (arr != null)
	{
		//content=WBTB_Composition.document.body.innerHTML;
...
{
	var arr = showModalDialog("wbTextBox/emot.htm", "", "dialogWidth:20em; dialogHeight:12em; status:0; help:0");
...
{
	var arr = showModalDialog("wbTextBox/backimage.htm", "", "dialogWidth:23em; dialogHeight:15.5em; status:0; help:0");
...
{
	var arr = showModalDialog("wbTextBox/file.htm", "", "dialogWidth:23em; dialogHeight:10.5em; status:0; help:0");
...
{	
	...
	var arr = showModalDialog("wbTextBox/href.htm", "", "dialogWidth:23em; dialogHeight:10.5em; status:0; help:0");
	WBTB_Composition.focus();
...
var WBTB_bIsIE5 = (navigator.userAgent.indexOf("IE 5")  > -1) || (navigator.userAgent.indexOf("IE 6")  > -1)|| (navigator.userAgent.indexOf("IE 7")  > -1)|| (navigator.userAgent.indexOf("IE 8")  > -1);
