...
<html>
<head>
<title>AdminRole_List.asp</title>
...
<table width="100%" border="0" cellspacing="5" cellpadding="0">
  <tr> 
    <td> 
      <input name="Submit32" type="button" class="button02-out" value="添加角色" onClick="window.location='AdminRole_Mdy.asp?Work=AddReco'"></td>
  </tr>
</table>
<%
Dim Rs
...
Dim Sql
    Sql="SELECT * From Admin_Role Order By ID DESC"
...
%>
  <tr> 
    ...
    <td width="24%" bgcolor="#FFFFFF"><%=Rs("Title")%></td>
    <td width="41%" bgcolor="#FFFFFF"><%=Rs("Content")%></td>
    <td width="14%" align="center" bgcolor="#FFFFFF"><%=FormatDateTime(Rs("upTime"),2)%></td>
    <td width="12%" align="center" bgcolor="#FFFFFF">
<input name="Submit3" type="button" class="button01-out" value="编  辑" onClick="window.location='AdminRole_Mdy.asp?id=<%=Rs("Id")%>'"></td>
  </tr>
<%
      Rs.MoveNext
  Next
