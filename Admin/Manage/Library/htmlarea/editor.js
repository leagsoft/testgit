...
this.btnList = {
    ...
    "subscript":      ['SubScript',            '脚码',                'editor_action(this.id)',  'ed_format_sub.gif'],
    "superscript":    ['SuperScript',          '首码',                'editor_action(this.id)',  'ed_format_sup.gif'],
    "justifyleft":    ['JustifyLeft',          '居左',                'editor_action(this.id)',  'ed_align_left.gif'],
    "justifycenter":  ['JustifyCenter',        '局中',                'editor_action(this.id)',  'ed_align_center.gif'],
    "justifyright":   ['JustifyRight',         '局右',                'editor_action(this.id)',  'ed_align_right.gif'],
    ...
    "indent":         ['Indent',               '增大缩进量',           'editor_action(this.id)',  'ed_indent_more.gif'],
    "forecolor":      ['ForeColor',            '前景色',              'editor_action(this.id)',  'ed_color_fg.gif'],
    "backcolor":      ['BackColor',            '背景色',              'editor_action(this.id)',  'ed_color_bg.gif'],
    "horizontalrule": ['InsertHorizontalRule', '横线',                'editor_action(this.id)',  'ed_hr.gif'],
    "createlink":     ['CreateLink',           '链接',                'editor_action(this.id)',  'ed_link.gif'],
    "insertimage":    ['InsertImage',          '图像',                'editor_action(this.id)',  'ed_image.gif'],
    "inserttable":    ['InsertTable',          '表格',                'editor_action(this.id)',  'insert_table.gif'],
    "htmlmode":       ['HtmlMode',             '可视化编辑／源码查看',  'editor_setmode(\''+objname+'\')', 'ed_html.gif'],
    "popupeditor":    ['popupeditor',          '全屏',                'editor_action(this.id)',  'fullscreen_maximize.gif'],
    "about":          ['about',                '关于',                'editor_about(\''+objname+'\')',  'ed_about.gif'],

    // Add custom buttons here:
    "custom1":        ['custom1',              '系统分页符',           'editor_action(this.id)',  'ed_split_page.gif'],
    "custom2":        ['custom2',              '横线',                'editor_action(this.id)',  'ed_hr.gif'],
...
function editor_action(button_id) {
  ...
  // Custom1
    ...
    if(confirm("<系统提示>\n是否要在当前位置插入＂Tsys 系统分页符＂\n关于此分页符的功能详见帮助．"))
    {
        editor_insertHTML(objname,"<HR sysPageSplitFlag>");
    }
  }
  ...
  // Custom2
    ...
    if (myText) { editor_insertHTML(objname, "fffffffffffffff"); }
  }
