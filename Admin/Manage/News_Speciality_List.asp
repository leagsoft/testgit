...
<table width="100%" border="0" cellspacing="3" cellpadding="0">
  <tr>
    <td> 
      <input name="Submit32" type="button" class="button02-out" value="添加特性" onClick="window.location='News_Speciality_Mdy.asp?Work=AddReco&Parent=<%=Parent%>'" title="在当前位置添加特性"></td>
  </tr>
</table>
<%
Dim Rs
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" class="ContentTabBg">
  <tr> 
    <td height="11" colspan="4" bgcolor="#FFFFFF"> <b><%=Spec_GetSpecialityPath(Parent,"?")%></b> 的子分类列表：</td>
  </tr>
  <tr class="BarTitleBg"> 
...
%>
  <tr> 
    ...
    <td width="12%" align="center" bgcolor="#FFFFFF"><input name="Submit3" type="button" class="button01-out" value="编  辑" onclick="window.location='News_Speciality_Mdy.asp?id=<%=Rs("Id")%>'">
    </td>
  </tr>
  <%
      Rs.MoveNext
