  ...
  <tr> 
    ...
    <td height="196" width="846"> 
      <table width="464" border="0" cellspacing="1" cellpadding="2">
        <form name="form1" method="post" enctype="multipart/form-data" action="UpFile_SaveFile.asp" onSubmit="return ChkForm(this)">
          <tr> 
	...
	return true;
          ...
          <tr> 
            ...
            <td width="84%"> <label for="AutoRename">
              <input type="checkbox" name="AutoRename" value="1" id="AutoRename">
              自动重命名文件</label></td>
          </tr>
        </form>
      </table>
