...
<%End If%>
    <tr> 
      ...
      <td bgcolor="#FFFFFF">
		<!--<input type="submit" name="SaveAddButton" id="SaveAddButton" value="..." >-->
...
<!--End Add-->
    <tr> 
      ...
      <td bgcolor="#FFFFFF">
		<!--<input name="SmallImg" type="text" class="Input" id="SmallImg" value="<%=cFun.HTMLEncode2(Rs("Filename"))%>" size="50">
        <input type="button" name="Button3" value="..." onClick="window.open('FileSystem2/View.asp','ResWin','resizable,scrollbars,width=600,height=500')">-->
