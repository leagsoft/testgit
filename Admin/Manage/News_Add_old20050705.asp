...
<%end if%>
    ...
    <tr> 
      ...
      <%Else%>	        
     <td width="84%" bgcolor="#FFFFFF"><input type="text" name="Author" class="Input" id="Author" value="<%=cFun.HTMLEncode2(Rs("Editor"))%>">&nbsp;&nbsp;<font color="red">*</font></td><%'=session("YHDL")%>
    
      <%End If%>
    </tr>
    <tr> 
      <td width="16%" class="BarTitle">来源:</td>
      <td width="84%" bgcolor="#FFFFFF"><input type="text" name="From" class="Input" id="From" value="<%=cFun.HTMLEncode2(Rs("FromBM"))%>">&nbsp;&nbsp;<font color="red">*</font></td><%'=session("YHBM")%>
    </tr>
    <tr> 
      <td width="16%" class="BarTitle">责任编辑:</td>
      <td bgcolor="#FFFFFF"><input name="Editor" type="text" class="Input" value="<%=cFun.HTMLEncode2(Rs("Editor"))%>"><%'=Session("YHDL")%>
      </td>
    </tr>
<!--Add by BennyLiu:20040712-->
    <%if QXMC="分局动态" then%>
...
<!--End Add-->    
    ...
    <tr id="trNewsContent"> 
      <td height="400" colspan="2" valign="top" bgcolor="buttonface" Id="tdNewsContent"> <textarea name="NewsContent"><%If (Not IsNull(Rs("Content"))) Or (Not ""<>Rs("Content")) Then Response.Write Server.HtmlEnCode(Rs("Content")) End If%></textarea></td>
    </tr>
    <tr> 
